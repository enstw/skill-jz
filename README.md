...
- **[authenticated-fetch](./authenticated-fetch/)** — User-assisted EZproxy and institutional login, persistent visible browser sessions, PDF discovery/download, and complete-or-explicitly-partial chapter merging. Depends on browser-cdp and robust-web-fetch.
