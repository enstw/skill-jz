...
- `flush/`, `sync/`, `init-agents/`, `recommend/`, `self-evaluate/`, `robust-web-fetch/`, `transcribe-pdf/`, `codex-image/`, `browser-screenshot/`, `img2/`, `img-nb/`, `img-canvas/`, `yt2sub/`, `repo-publish/`, ... — one folder per skill.
